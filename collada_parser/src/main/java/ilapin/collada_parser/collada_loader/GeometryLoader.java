...
import ilapin.collada_parser.data_structures.Vertex;
...
public class GeometryLoader {
	...
	private final List<XmlNode> meshesData;
	...
	public GeometryLoader(final XmlNode geometryNode, final List<VertexSkinData> vertexWeights) {
		this.vertexWeights = vertexWeights;
		meshesData = new ArrayList<>();
		for (final XmlNode meshNode : geometryNode.getChildren("geometry")) {
			meshesData.add(meshNode.getChild("mesh"));
		}
	...
	private void readPositions() {
		for (final XmlNode meshData : meshesData) {
